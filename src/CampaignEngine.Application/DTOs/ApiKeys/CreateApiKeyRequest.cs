...
{
    /// <summary>Human-readable label for this key. Must be unique.</summary>
    [Required]
    [MaxLength(200)]
    public string Name { get; init; } = string.Empty;

    /// <summary>Optional notes about the intended consumer of this key.</summary>
    [MaxLength(500)]
    ...
    /// Must be between 1 and 100000 if provided.
    /// </summary>
    [Range(1, 100000)]
    ...
    /// Default: 365 days (1 year) per business rule.
    /// </summary>
    [Range(1, 3650)]
