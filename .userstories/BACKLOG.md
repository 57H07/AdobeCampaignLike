...
**Acceptance criteria:**
- [ ] HTML files stored in `templates/{templateId}/v{version}.html`
- [ ] UTF-8 encoding preserved
- [ ] Email/SMS rendering logic reads from file system (not DB)
- [ ] Existing Email/SMS templates tested for regression

**Technical tasks:**
- [ ] `TASK-007-01` - **[Service]** Update Email/SMS create path to save HTML files
- [ ] `TASK-007-02` - **[Service]** Update Email/SMS update path to version HTML files
- [ ] `TASK-007-03` - **[Renderer]** Update Scriban renderer to read from `ITemplateBodyStore`
- [ ] `TASK-007-04` - **[Test]** Email template unit tests
- [ ] `TASK-007-05` - **[Test]** SMS template unit tests
- [ ] `TASK-007-06` - **[Test]** Regression tests for existing Email/SMS workflows
